...
export const socialLinks: IExternalLink[] = [
  {
    ...
    href: 'https://onlyfans.com/gorakuicu',
  },
  {
    name: 'Tumblr',
    svg: '/assets/icons/links/tumblr.svg',
    href: 'https://gorakuicu.tumblr.com/',
  },
  {
    name: 'Twitter',
    svg: '/assets/icons/links/twitter.svg',
    href: 'https://twitter.com/gorakuicu',
  },
  {
    name: 'Pinterest',
    svg: '/assets/icons/links/pinterest.svg',
    href: 'https://www.pinterest.com/gorakuicu/',
  },
  {
    name: 'Instagram',
    svg: '/assets/icons/links/instagram.svg',
    href: 'https://www.instagram.com/gorakuicu/',
  },
  {
    name: 'DeviantArt',
    svg: '/assets/icons/links/deviantart.svg',
    href: 'https://www.deviantart.com/gorakuicu',
  },
];
...
export const communityLinks: IExternalLink[] = [
  ...
  },
  {
    ...
    href: 'https://t.me/gorakuicu',
  },
  {
    name: 'Reddit',
    svg: '/assets/icons/links/reddit.svg',
    href: 'https://www.reddit.com/user/gorakuicu',
  },
  {
    name: 'Pillowfort',
    svg: '/assets/icons/links/pillowfort.svg',
    href: 'https://www.pillowfort.social/gorakuicu',
  },
  {
    name: 'Newgrounds',
    svg: '/assets/icons/links/newgrounds.svg',
    href: 'https://gorakuicu.newgrounds.com/',
  },
  {
    name: 'Mastodon',
    svg: '/assets/icons/links/mastodon.svg',
    href: 'https://mastodon.social/@gorakuicu',
  },
];
...
export const contactLinks: IExternalLink[] = [
  {
    ...
    href: 'mailto:contact@goraku.icu',
  },
];
...
export const supportLinks: IExternalLink[] = [
  {
    ...
    href: 'https://bmc.link/gorakuicul',
  },
  {
    name: 'Patreon',
    svg: '/assets/icons/links/patreon.svg',
    href: 'https://patreon.com/gorakuicu',
  },
  {
    name: 'Boosty',
    svg: '/assets/icons/links/boosty.svg',
    href: 'https://boosty.to/gorakuicu',
  },
  {
