...
meta:
  ...
  - name: description
    content: This is the Shipping Policy for goraku.icu and gorakuicu apps.
headers:
...
<CommonLayout>
  <article className="prose dark:prose-invert">
    ...
    This Shipping & Delivery Policy is part of our Terms of Use ("Terms") and should be therefore read alongside our main Terms: [goraku.icu/legal/terms](/legal/terms).
    ...
    If you have questions about returns, please review our Return Policy: [goraku.icu/legal/return](/legal/return).
