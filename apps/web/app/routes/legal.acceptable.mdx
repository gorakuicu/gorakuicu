...
meta:
  ...
  - name: description
    content: This is the Acceptable Use Policy for https://goraku.icu and gorakuicu apps.
headers:
...
This Acceptable Use Policy ("**Policy**") is part of our Terms of Use ("**Legal Terms**") and should therefore be read alongside our main Legal Terms: https://goraku.icu/legal/terms. If you do not agree with these Legal Terms, please refrain from using our Services. Your continued use of our Services implies acceptance of these Legal Terms.
...
We are gorakuicu ("**Company**," "**we**," "**us**," or "**our**") a company in Germany, Berlin. We operate the website https://goraku.icu (the "**Site**"), the mobile application gorakuicu (the "**App**"), as well as any other related products and services that refer or link to this Policy (collectively, the "**Services**").
